...
<head>
    ...
    <title>MealSync - Register Pembeli</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .form-title { font-size: 38px; font-weight: 700; color: #333333; margin-bottom: 30px; line-height: 1.2; }
        ...
        .divider { display: flex; align-items: center; text-align: center; color: #777; font-size: 13px; font-weight: 600; margin-bottom: 20px; }
    ...
    <div class="split-container">
        ...
        <div class="form-side">
            ...
            <div class="form-wrapper">
                <h2 class="form-title">Buat Akun<br>Baru !</h2>
                ...
                <form action="login_pembeli.php" method="POST">
                    ...
                    <div class="switch-auth">
                        Sudah Punya Akun? <a href="login_pembeli.php">Sign In</a>
                    </div>
                </form>
            </div>
        </div>
